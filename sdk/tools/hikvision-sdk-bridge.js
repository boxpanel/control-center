...
class HikvisionSdkBridge {
  ...
  async setTriggerConfig(connection, values = {}) {
    return this.runJavaTool("set-trigger-config", connection, [
      ...
      String(Number(values.videoEpoliceIntervalType || 0) || 0),
      String(Number(values.videoEpoliceIntervalMs || 0) || 0),
      values.videoEpoliceCheckpointEnabled ? "1" : "0",
      String(Number(values.videoEpoliceCheckpointLevel || 1) || 1),
      values.videoEpoliceWrongDirectionEnabled ? "1" : "0",
      values.videoEpoliceIllegalUTurnEnabled ? "1" : "0",
      String(Number(values.videoEpoliceIllegalUTurnLevel || 1) || 1),
      values.videoEpoliceIllegalLaneChangeEnabled ? "1" : "0",
      String(Number(values.videoEpoliceIllegalLaneChangeLevel || 1) || 1),
      values.videoEpoliceReverseEnabled ? "1" : "0",
      String(Number(values.videoEpoliceReverseLevel || 1) || 1),
      values.videoEpoliceLaneLineEnabled ? "1" : "0",
      String(Number(values.videoEpoliceLaneLineLevel || 1) || 1),
      String(Number(values.videoEpoliceLaneLineSensitivity || 0) || 0),
      values.videoEpoliceMotorOccupyNonMotorEnabled ? "1" : "0",
      String(Number(values.videoEpoliceMotorOccupyNonMotorLevel || 1) || 1),
      String(Number(values.videoEpoliceStopSeconds || 0) || 0),
      values.videoEpoliceIntersectionStopEnabled ? "1" : "0",
      values.videoEpoliceGreenLightStopEnabled ? "1" : "0",
      values.videoEpoliceProhibitionSignEnabled ? "1" : "0",
      String(Number(values.videoEpoliceProhibitionSignLevel || 1) || 1),
      values.videoEpoliceSpeedingEnabled ? "1" : "0",
      String(Number(values.videoEpoliceSpeedingLevel || 1) || 1),
      values.videoEpoliceRedLightEnabled ? "1" : "0",
      String(Number(values.videoEpoliceCarDriveDirect || 0) || 0),
      String(Number(values.videoEpoliceTrafficLightDetect || 0) || 0),
      String(Number(values.videoEpoliceCopyParamMask || 1) || 1)
    ]);
  }
